---
description: Review a pull request at the ceiling of clarity — fetch it via gh, trace the change in the actual code, produce the Story/Delta/Focus visuals via the /visuals engine, and draft a complete review: what the PR does in plain language, findings ranked by severity, genuine questions, and a verdict. Nothing is posted until you approve.
---
...
PR to review (number, URL, or head branch — may be empty): $ARGUMENTS
...
Follow the /visuals engine (`~/.commands/visuals.md`) in **review mode**. It yields:
