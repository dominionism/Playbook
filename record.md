---
description: Capture a concept, explanation, or analogy into your personal engineering textbook at ~/Developer/The Architect/. Works retroactively (save what you just explained), on-demand (research then save), or manually.
---

Record a concept into your personal engineering textbook. The textbook lives at `~/Developer/The Architect/` and accumulates every concept you master — a reference you build over time.
...
Write to `~/Developer/The Architect/Chapters/<Concept-Name>.md`. Create `Chapters/` if it doesn't exist. Use this template:
...
Write (or update) `~/Developer/The Architect/Glossary.md`. Create it if it doesn't exist. Append the new entry, then sort alphabetically:
