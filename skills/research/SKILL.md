---
name: research
description: Map a codebase or feature for confident work in the current session. Use when the user explicitly asks to research a repository; trace architecture, domain concepts, patterns, data flow, and relevant history without producing speculative documentation.
compatibility: Requires repository file access; symbol references require a compatible language server.
---
