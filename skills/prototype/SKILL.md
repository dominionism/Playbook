---
name: prototype
description: Build disposable code to answer a high-fidelity engineering question. Use when the user explicitly asks to prototype behavior or compare UI directions; preserve the learning, then remove or absorb the temporary code.
---
