---
name: recall
description: Resume from Playbook context and the latest project handoff. Use when the user explicitly asks to recall prior work; absorb Research, Glossary, ADRs, and Plan first, read the latest Memories delta, verify repository state, and continue from the exact next action.
compatibility: Requires git and a project containing Playbook's Context or Memories directories.
---
