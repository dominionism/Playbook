---
name: blueprint
description: Create an optimal implementation plan. Use when the user explicitly asks to plan a substantial engineering change before implementation; decompose the target, research genuine uncertainties with hard termination, and produce a plan at the ceiling of what is knowable before writing code.
---
