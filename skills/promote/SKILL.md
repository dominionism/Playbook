---
name: promote
description: Promote implementation learnings into durable project context. Use when the user explicitly asks to reconcile completed work with the plan, glossary, ADRs, and research notes; propose every change and write only what the user confirms.
compatibility: Requires git and a project using Playbook's Context and Memories directories.
---
