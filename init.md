---
description: Bootstrap the project's Context/ and Memories/ directories with empty templates. Run once per project, before /research or /grill, so other commands never need to create scaffolding.
---
