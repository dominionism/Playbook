---
description: Lightweight incremental capture — dump what you can recall, skip the analysis. The recall agent does the hard work later, in a fresh context window.
---
